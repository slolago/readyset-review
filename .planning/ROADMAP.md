...
Plans:
- [ ] 74-01-PLAN.md — PERF-10..14 surgical fixes: preload=metadata, thumbnail poster, Fabric pre-warm, lazy VUMeter, Suspense-split comment sidebar + skeleton
...
Plans:
- [x] 77-01-PLAN.md — PERF-22 parallelize useProject mount + PERF-23 stabilize AssetGrid callbacks + narrow RenameProvider scope (AssetGrid/AssetListView already memoized — confirmed via scouting)
